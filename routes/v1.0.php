...
$app->group('/v1.0', function() {
    ...
    $this->post('/send', function ($request, $response, $args) {
        ...
        $attachment =  $pdf->Output('S', $pdf_name);
        $html = '<h1>GDF Documentos</h1>' .
        '<p>Se adjuntó el archivo ' . $pdf_name . '.pdf.</p>' .
        '<p>Que tengas une excelente día.</p>' . 
        '<small>Enviado automáticamente por GDF Documentos</small>';
